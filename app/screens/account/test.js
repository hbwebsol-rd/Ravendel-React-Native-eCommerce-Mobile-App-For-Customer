...
const SavedAddressScreen = ({ navigation, route }) => {
    ...
    }, [isFocused, userDetails, dispatch]);
    ...
    }, [isFocused, userDetails.addressBook]);
                    ...
                    <View style={styles.addressContentWrapper} key={index}>
                        ...
                        <View>
                            <View style={styles.namePhoneWrapper}>
                                <AText bold medium>{item.firstName}</AText>
                                <AText xtrasmall bold medium>{item.phone}</AText>
                            </View>
    ...
    return (
        <MainLayout hideScroll>
            {loading && <AppLoader />}
            {(isEmpty(userDetails) && isEmpty(userDetails.addressBook)) || addressForm ? (
                <AdressForm
